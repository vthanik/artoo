...
![The artoo lossless round-trip, centred on write and read across formats.](../man/figures/round-trip-hero.svg){fig-alt="A conformed frame writes to a file in any format and reads back identical; the dashed loop labelled lossless round-trip closes from identical data back to the start." width="100%"}
