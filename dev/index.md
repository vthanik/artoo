...
is the quick look a SAS programmer expects from `PROC CONTENTS`, on a
...
|----|----|----|----|
| SAS XPORT (XPT) | [`read_xpt()`](https://vthanik.github.io/artoo/dev/reference/read_xpt.md) | [`write_xpt()`](https://vthanik.github.io/artoo/dev/reference/write_xpt.md) | FDA / PMDA submission |
| CDISC Dataset-JSON | [`read_json()`](https://vthanik.github.io/artoo/dev/reference/read_json.md) | [`write_json()`](https://vthanik.github.io/artoo/dev/reference/write_json.md) | Modern CDISC interchange |
| NDJSON | [`read_ndjson()`](https://vthanik.github.io/artoo/dev/reference/read_ndjson.md) | [`write_ndjson()`](https://vthanik.github.io/artoo/dev/reference/write_ndjson.md) | Streaming Dataset-JSON |
| Apache Parquet | [`read_parquet()`](https://vthanik.github.io/artoo/dev/reference/read_parquet.md) | [`write_parquet()`](https://vthanik.github.io/artoo/dev/reference/write_parquet.md) | Analytics, columnar store |
| RDS | [`read_rds()`](https://vthanik.github.io/artoo/dev/reference/read_rds.md) | [`write_rds()`](https://vthanik.github.io/artoo/dev/reference/write_rds.md) | Fast R-native storage |
