...
```
    ...
    file1e855b9a8f47.json  DM      Demographics  60       15         json
...
- [Formats & lossless
  conversion](https://vthanik.github.io/artoo/dev/articles/convert.md) —
  the round trips these ship lines rely on.
