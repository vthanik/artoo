...
```
    ...
    ! Could not read '/tmp/Rtmp3EJZUE/file1e4a2a73aca.parquet' as "parquet".
...
migration
article](https://vthanik.github.io/artoo/dev/articles/migrate-encoding.md)).
...
- [Specifications](https://vthanik.github.io/artoo/dev/articles/specs.md)
  — the spec whose metadata every codec carries.
- [Conform &
  validate](https://vthanik.github.io/artoo/dev/articles/conform.md) —
  produce the conformed frame these writers persist.
- [Recipes](https://vthanik.github.io/artoo/dev/articles/recipes.md) —
  conversion inside an end-to-end ADaM and SDTM build.
- [Get started](https://vthanik.github.io/artoo/dev/articles/artoo.md) —
