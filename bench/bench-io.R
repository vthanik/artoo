# bench-io.R -- the vport I/O benchmark harness (dev-only, .Rbuildignore'd).
#
...
#
# The opt-in perf-regression smoke (VPORT_BENCH=1, test-stress.R) compares
...
# ~0.5s. Pure-R vport targets: xpt write within ~2x of haven's C writer.
