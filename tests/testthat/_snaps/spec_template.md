...
# a blank template reads back as an empty-but-valid starting point
    ...
    Condition
      ...
      i Available sheets: "Study", "Datasets", "Variables", "ValueLevel", "WhereClauses", "Codelists", "Dictionaries", "Methods", "Comments", "Documents", "Standards", "Analysis Displays", "Analysis Results", and "Analysis Criteria".
